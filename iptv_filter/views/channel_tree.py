...
class ChannelTree(ttk.Treeview):
    def __init__(self, parent, **kwargs):
        columns = ("id", "name", "country", "categories", "languages", "streams")
    ...
    def _copy_url(self):
        ...
        item_id = selected[0]
        channel_id = self.item(item_id, "values")[0]
    ...
    def populate(self, channels: List[Channel]):
